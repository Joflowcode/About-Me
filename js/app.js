...
if(questionTwo === 'yes' || questionTwo === 'yas' || questionTwo === 'y'){
  ...
  alert('Nope! It was terrifying, and not sure I could ever replicate the 3 mile trip that I was scared and miserable the whole way. But it has become one of my favorite memories.');
}
